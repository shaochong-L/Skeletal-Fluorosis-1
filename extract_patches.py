...
def get_data_training(DRIVE_train_imgs_original: object,
                      DRIVE_train_groudTruth: object,
                      patch_height: object,
                      patch_width: object,
                      N_subimgs: object,
                      inside_FOV: object) -> object:
...
def get_data_testing_overlap(DRIVE_test_imgs_original: object, DRIVE_test_groudTruth: object, Imgs_to_test: object, patch_height: object,
                             patch_width: object,
                             stride_height: object,
                             stride_width: object) -> object:
    ### test
    test_imgs_original = load_hdf5(DRIVE_test_imgs_original)
    test_masks = load_hdf5(DRIVE_test_groudTruth)
...
def extract_random(full_imgs: object, full_masks: object, patch_h: object, patch_w: object, N_patches: object, inside: object = True) -> object:
...
def pred_only_FOV(data_imgs: object, data_masks: object, original_imgs_border_masks: object) -> object:
...
def kill_border(data: object, original_imgs_border_masks: object) -> object:
    assert (len(data.shape)==4)  #4D arrays
    assert (data.shape[1]==1 or data.shape[1]==3)  #check the channel is 1 or 3
    height = data.shape[2]
    width = data.shape[3]
...
def inside_FOV_DRIVE(i: object, x: object, y: object, DRIVE_masks: object) -> object:
